        ...
        <div className="min-h-screen bg-gray-50 px-4 py-6">
            <div className= "mx-auto max-w-md rounded-lg bg-white shadow-sm">
                ...
                <div className=" divide-y">
                    <div className="flex curser-pointer items-center gap-4 p-5 hover:bg-gray-50" onClick={()=>{navigate("/orders")}}>
                ...
                <div className=" divide-y">
                    <div className="flex curser-pointer items-center gap-4 p-5 hover:bg-gray-50" onClick={()=>{navigate("/address")}}>
                ...
                <div className=" divide-y">
                    <div className="flex curser-pointer items-center gap-4 p-5 hover:bg-gray-50" onClick={logoutHandler}>
